<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <a href="{{ route('recipes.index') }}" class="border border-bleu_clair text-bleu_fonce rounded-md py-2 px-3">
            Retour aux recettes
        </a>
    </x-slot>
        ...
        <form
            ...
            <div class="py-4">
                ...
                @foreach ($themes as $theme)
                    <input class="flex-col checked:bg-cyan-500 active-boxOuter rounded" type="checkbox" name="themes[]" value="{{ $theme->id }}">
