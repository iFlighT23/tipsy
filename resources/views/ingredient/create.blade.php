<x-app-layout>
    ...
    <div class="relative overflow-x-auto mt-12 max-w-xl mx-auto px-8">
        ...
        action="{{ route('ingredients.store') }}" method="POST">
            @csrf
            ...
            <div class="flex justify-center">
                <button
                    type="submit" class="flex items-center justify-center h-8 px-2 w-36 bg-blue-600 mt-8 rounded font-semibold text-sm text-blue-100 hover:bg-blue-700">Enregister
                </button>
            </div>
