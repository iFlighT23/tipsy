        ...
        <nav class="flex justify-between items-center bg-bleu_clair h-20 font-poppins px-4 gap-36">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="group">
                    ...
                    <img src="/img/planche.svg" alt="planche"
                        class="hidden group-hover:block ml-4 w-24 shadow-lg shadow-bleu group-hover:animate-fade-right hover:animate-duration-500">
                </div>
            </div>
                ...
                <form action="{{ route('filter.ingredient') }}" method="POST">
                    ...
                    <div class="flex">
                        ...
                        <input type="text" name="search" value="{{ isset($_GET['search']) ? $_GET['search'] : '' }}"
                            class="bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Rechercher un cocktail ou un ingrédient">
                        <button type="submit"
                            class="p-2.5 ml-2 font-mediumtext-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800  font-medium rounded-lg text-sm text-center mr-2 ">
            ...
            <div class="flex items-center">
                ...
                <div>
                    <form action="{{ route('register') }}">
                        <button type="submit"
                            class="text-gray-800 w-24 bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-poppins rounded-lg text-sm px-5 py-2 mr-2">
                            Sign up
                        </button>
                    </form>
                </div>
