<x-app-layout>
    ...
    <div id="modal-bg" class=" w-full h-full top-0 absolute hidden bg-slate-200 bg-opacity-20 backdrop-blur-sm">
        <div id="modal-box" class=" w-2/5 h-3/5  bg-old drop-shadow-3xl rounded-lg -translate-y-1/2 p-6 top-1/2 left-1/2 -translate-x-1/2 absolute hidden">
                    ...
                    <div>
                        ...
                        <div class="text-sm">
                            <ul class="marker:text-sunset list-disc">
                                <li>Dans un verre, placer les glaçons jusqu'en haut, puis ajouter le sirop de fraise</li>
                                <li>Verser le jus d'orange tout doucement sur une cuillère à soupe par dessus le sirop.
                                </li>
                                <li>Colorer la limonade puis ajoutez-la, doucement, par dessus le jus d'orange à l'aide
            ...
            <div>
                <p class="text-sm m-6 font-poppins">Ce cocktail aurait été créé en 1948 à Acapulco par une Américaine,
                    Margaret Sames, dite
                    « Margarita »4,
                    et porte comme nom la traduction en espagnol du prénom Margaret. Une autre version dit qu'il fut
                    créé
                    par
                    Carlos « Danny » Herrera dans son restaurant au sud de Tijuana en hommage à une actrice américaine
                    nommée
                    Marjorie King 5,4. On évoque aussi le cocktail Tequila Daisy (« marguerite » en français, «
                    margarita »
                    en
                    espagnol) comme source possible du nom.</p>
            </div>
        </div>
    </div>
</x-app-layout>
