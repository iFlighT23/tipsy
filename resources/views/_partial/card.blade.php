<div class="py-12 flex flex-row justify-around">
    <div class="flex flex-col  items-stretch w-64  -rotate-6 bg-sable_fonce rounded hover:shadow hover:rotate-6 hover:drop-shadow-xl relative max-w-xs overflow-hidden bg-cover hover:border-solid hover:border-y- hover:border-t-whithe">
        <div>
